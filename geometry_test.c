...
Suite* coord_2d_suite(void)
{
    ...
    TCase* tc_2d_area_traingle = tcase_create("coord_2d_area_triangle");
    tcase_add_test(tc_2d_area_traingle, test_2d_area_triangle);

    /* Add Cases to Suite */
    suite_add_tcase(s, tc_2d_eq);
    suite_add_tcase(s, tc_2d_dist);
    suite_add_tcase(s, tc_2d_midpoint);
    suite_add_tcase(s, tc_2d_area_traingle);
